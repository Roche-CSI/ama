	...
	return (
		<div className="flex w-full items-center relative">
			...
			<div className="xl:hidden">
				...
				{leftMenuOpen && (
					<div className="absolute left-0 top-full mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 z-1">
...
const TabLabel: React.FC<TabLabelProps> = ({tab, active, onClick, floatRight=false}) => {
	...
	return (
		<Link
			to={tab.link}
			className={`hover:no-underline hover:text-blue-500 py-2 ${
				floatRight ? "pl-4" : "pr-4"
			} flex ${active ? 'border-b-2 border-gray-600 font-bold' : ''}`}
