		...
		<div className="w-full max-w-md rounded-lg border border-base-300 bg-white/50 backdrop-blur-sm overflow-hidden hover:shadow-lg transition-all duration-300">
			...
			<div className="p-6">
				<div className="flex items-center justify-between mb-4">
					...
					{/*	<AlertTriangle className={`w-5 h-5 ${importanceConfig.color}`}/>*/}
					{/*	<div*/}
					{/*		className="invisible group-hover:visible absolute -top-8 right-0 px-2 py-1 bg-gray-800 text-white text-xs rounded whitespace-nowrap">*/}
