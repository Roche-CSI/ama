...
import AssetCard from "pages/assetClassPageV2/cards/AssetCard.tsx";
...
export default function AssetListView(props: BrowserProps) {
	...
	const onPageChange = (page: number, rowsPerPage: number) => {
		setCurrentPage(page)
		fetchAssetsFromServer({pageNumber: page, pageSize: rowsPerPage})
	}
				...
				}
                {
                    ...
                    <div>
                        ...
                        <ControlledDataGrid cols={3}
                                            ...
                                            length={props.assetClass.counter}
